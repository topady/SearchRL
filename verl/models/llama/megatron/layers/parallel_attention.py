...
from verl.utils.bert_padding import index_first_axis, pad_input, unpad_input
...
try:
    ...
    _HAS_FLASH_ATTN_ROTARY = True
except ImportError:
    _HAS_FLASH_ATTN_ROTARY = False
