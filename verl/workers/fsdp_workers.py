...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
        ...
        if use_remove_padding and self.ulysses_sequence_parallel_size > 1 and \
           self.config.model.get('attn_implementation', 'flash_attention_2') == 'flash_attention_2':
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        if use_remove_padding and self.ulysses_sequence_parallel_size > 1 and \
           config.model.get('attn_implementation', 'flash_attention_2') == 'flash_attention_2':
            from verl.models.transformers.monkey_patch import apply_monkey_patch
...
class RewardModelWorker(Worker):
    ...
    def _forward_micro_batch(self, micro_batch):
        from verl.utils.bert_padding import pad_input, unpad_input, index_first_axis
